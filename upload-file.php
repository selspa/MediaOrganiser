...
if((isset($_POST['file_name']) || $_POST['file_name'] != "") && !in_array($_POST['file_name'], $titles)){
   ...
   if(isset($_FILES['fileToUpload']) && $_FILES['fileToUpload']['error'] == 0){
       ...
       // set files variables
       $target_dir = "uploads/";
       $fileTypes = ["audio/aac", "audio/mp3", "audio/mpeg", "audio/wav", "audio/ogg"];
       $err_message = "Sorry, you can only upload audio files (ACC, MP3, OGG, WAV)";
     ...
     $f->getImageID($imageName, $image_path);
         ...
         if($_FILES['fileToUpload']['error'] == 1){
           ...
           echo "Error - You need to upload an audio file (ACC, MP3, OGG, WAV)";
         }
       }
